...
class UserPersonalInformationLocalStorage @Inject constructor(
    @IoScheduler
    ...
    private var userPersonalInformation: UserPersonalInformation? = null
    ...
    override fun getUserPersonalInformation(): Single<UserPersonalInformation> {
        val userInformationTemp = userPersonalInformation
