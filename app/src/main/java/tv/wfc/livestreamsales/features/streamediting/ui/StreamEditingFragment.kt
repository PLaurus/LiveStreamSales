...
import tv.wfc.livestreamsales.databinding.FragmentStreamEditingBinding
...
class StreamEditingFragment : BaseFragment(R.layout.fragment_stream_editing) {
    ...
    private var viewBinding: FragmentStreamEditingBinding? = null
    ...
    private fun bindView(view: View) {
        viewBinding = FragmentStreamEditingBinding.bind(view)
    ...
    private fun FragmentStreamEditingBinding.initialize() {
...
//         initializeToast()
    ...
    private fun FragmentStreamEditingBinding.initializeContentLoader() {
        contentLoader.apply {
    ...
    private fun FragmentStreamEditingBinding.initializeNameTextInputEditText() {
    ...
    private fun FragmentStreamEditingBinding.initializeDescriptionTextInputEditText() {
    ...
    private fun FragmentStreamEditingBinding.initializeStartDateButton() {
        startDateButton.apply {
            val startDateIsNotSetText =
                getString(R.string.fragment_stream_editing_start_date_not_set)
    ...
    private fun FragmentStreamEditingBinding.initializeStartTimeButton() {
        startTimeButton.apply {
            val startTimeIsNotSetText =
                getString(R.string.fragment_stream_editing_start_time_not_set)
    ...
    private fun FragmentStreamEditingBinding.initializeEndDateButton() {
        endDateButton.apply {
            val endDateIsNotSetText =
                context.getString(R.string.fragment_stream_editing_end_date_not_set)
    ...
    // private fun FragmentStreamEditingBinding.initializeEndTimeButton() {
    //     endTimeButton.apply {
    //         val endTimeIsNotSetText = getString(R.string.fragment_stream_editing_end_time_not_set)
    ...
    private fun FragmentStreamEditingBinding.initializeEndDateTimeGroup() {
    ...
    private fun FragmentStreamEditingBinding.initializePreviewImage() {
        val placeholder = requireContext().getDrawableCompat(
            R.drawable.ic_baseline_image_24,
            R.color.broadcastEditingFragment_previewImage_placeholder_tint
        )
     ...
     private fun FragmentStreamEditingBinding.initializePreviewCard() {
         previewCard.apply {
             clicks()
                 .throttleLatest(500L, TimeUnit.MILLISECONDS, computationScheduler)
                 .observeOn(mainThreadScheduler)
     ...
     private fun FragmentStreamEditingBinding.initializeCreateButton() {
         saveMaterialButton.apply {
             viewModel.isStreamUpdateAvailable.observe(viewLifecycleOwner, ::setEnabled)

             clicks()
                 .throttleLatest(500L, TimeUnit.MILLISECONDS, computationScheduler)
                 .observeOn(mainThreadScheduler)
                 .subscribeBy(
                     onNext = { viewModel.updateStream() },
                     onError = applicationErrorsLogger::logError
                 )
                 .addTo(viewScopeDisposables)
         }
    ...
    private fun FragmentStreamEditingBinding.initializeToast() {
    ...
    private fun navigateToStartDatePicker(minDate: Long, maxDate: Long? = null) {
        ...
        val datePicker = MaterialDatePicker.Builder.datePicker()
            .setTitleText(R.string.fragment_stream_editing_start_date_label)
        ...
        datePicker.apply {
            ...
            show(this@StreamEditingFragment.parentFragmentManager, "startDatePickerDestination")
        }
    }
    ...
    private fun navigateToStartTimePicker() {
        val timePicker = MaterialTimePicker.Builder()
            ...
            .setTitleText(R.string.fragment_stream_editing_start_time_label)
            .build()
        ...
        timePicker.apply {
            ...
            show(this@StreamEditingFragment.parentFragmentManager, "startTimePickerDestination")
        }
    }

    private fun navigateToEndDatePicker(minDate: Long) {
        val datePicker = MaterialDatePicker.Builder.datePicker()
            .setTitleText(R.string.fragment_stream_editing_end_date_label)
            .setCalendarConstraints(
                CalendarConstraints.Builder()
        ...
        datePicker.apply {
            ...
            show(this@StreamEditingFragment.parentFragmentManager, "endDatePickerDestination")
        }
    }

    private fun navigateToEndTimePicker() {
        val timePicker = MaterialTimePicker.Builder()
            .setTitleText(R.string.fragment_stream_editing_end_time_label)
            .setTimeFormat(if (is24HourFormat(requireContext())) TimeFormat.CLOCK_24H else TimeFormat.CLOCK_12H)
            .build()
        ...
        timePicker.apply {
            ...
            show(this@StreamEditingFragment.parentFragmentManager, "endTimePickerDestination")
        }
    }
    ...
    private fun navigateToPreviewImagePicker() {
        ...
        val chooserTitle =
            requireContext().getString(R.string.fragment_stream_editing_choose_application_to_pick_image)
