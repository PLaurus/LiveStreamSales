package tv.wfc.livestreamsales.ui.activity.login.fragments.phonenumberinput
...
class PhoneNumberInputFragment: LogInFragment(R.layout.fragment_phone_number_input) {
    ...
    private fun createPhoneNumberInputComponent(){
        phoneNumberInputComponent = authorizationComponent.phoneNumberInputComponent().create(this)
    }
